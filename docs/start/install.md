...
pip install uv
uv pip install "sglang[all]>=0.4.5.2" --find-links https://flashinfer.ai/whl/cu124/torch2.5/flashinfer-python
```
...
git clone -b v0.4.5.2 https://github.com/sgl-project/sglang.git
cd sglang
...
```bash
docker build --build-arg SGL_BRANCH=v0.4.5.2 -t v0.4.5.2-rocm630 -f Dockerfile.rocm .
...
drun v0.4.5.2-rocm630 python3 -m sglang.bench_one_batch --batch-size 32 --input 1024 --output 128 --model amd/Meta-Llama-3.1-8B-Instruct-FP8-KV --tp 8 --quantization fp8
```
